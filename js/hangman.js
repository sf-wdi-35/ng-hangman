...
var HangmanGame = function(secretWord, tries) {
 var arr = ["snollygoster", "pedagogy", "omnipresent", "resistance", "interplanetary", "rescind", "fascism", "groupthink", "doublespeak" ];
 this.secretWord = arr[Math.floor(Math.random() * arr.length)];
 this.input = "";
 this.guesses = [];
